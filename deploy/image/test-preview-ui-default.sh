...
default_builder_catalogs='m3-catalog'
# The published default, once, for the same reason. It is DERIVED by intersecting the served list
# with the catalogs that have a usable published file, so with the default served list the two
# strings coincide. They are still separate variables here: they answer
...
default_published_catalogs='m3-catalog'
