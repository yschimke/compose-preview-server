...
dependencies {
  ...
  testImplementation("androidx.compose.remote:remote-player-view:1.0.0-alpha20")
  testImplementation("androidx.compose.remote:remote-core:1.0.0-alpha20")
  testImplementation("androidx.compose.remote:remote-player-core:1.0.0-alpha20")
