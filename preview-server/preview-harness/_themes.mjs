...
//
// A four-line copy of what `vscode-extension/preview-harness/_fixtures.mjs` exports, and the only
...
// back into `vscode-extension/` would be a new cross-boundary dependency of exactly the kind the
