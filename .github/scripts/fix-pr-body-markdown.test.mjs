...
const URL_ = 'https://raw.githubusercontent.com/yschimke/compose-preview-server/0a6c923/docs/x.png'
...
test('repairs relative paths and anchors', () => {
  ...
  assert.equal(
    fixPrBodyMarkdown('[why](`./docs/UI_BUILDER_GETTING_STARTED.md#compose-export-needs-a-component-record`)'),
    '[why](./docs/UI_BUILDER_GETTING_STARTED.md#compose-export-needs-a-component-record)',
  )
})
...
test('leaves well-formed markdown alone', () => {
  const body = `## Summary\n\n![alt](${URL_})\n\nRun \`./gradlew check\` — see [docs](docs/README.md).\n`
